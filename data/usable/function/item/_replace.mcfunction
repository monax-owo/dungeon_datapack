...
execute if data entity @s SelectedItem.components.minecraft:custom_data.looting run item modify entity @s weapon.mainhand {function:"set_custom_data",tag:{looting:{silent:true}}}
