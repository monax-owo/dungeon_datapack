...
$execute if $(data)[$(index)].buy run data modify storage util: args[-1] merge from $(data)[$(index)].buy
$execute if data $(data)[$(index)].buy run function money:villager/buy with storage util: args[-1]
$execute if $(data)[$(index)].sell run data modify storage util: args[-1] merge from $(data)[$(index)].sell
