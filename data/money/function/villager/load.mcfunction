...
data modify storage money: _villager.potion set value [\
...
function money:villager/set_data {data:"storage money: _villager.potion",output:"storage money: villager.potion"}
