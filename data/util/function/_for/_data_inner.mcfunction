...
$execute store result storage util: args[-1].index int 1 run scoreboard players get #index.$(for_id) for_data_temp

# TODO: ref
function util:_for/_data_inner_next with storage util: args[-1]
