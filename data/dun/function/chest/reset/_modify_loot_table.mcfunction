...
$execute if data storage util: args_0{tier:1} run data modify block $(pos) LootTable set value "dun:normal_chest"
$execute if data storage util: args_0{tier:2} run data modify block $(pos) LootTable set value "dun:rare_chest"
$execute if data storage util: args_0{tier:2} run data modify block $(pos) lock set value {predicates:{custom_data:{dun:{key:1b}}}}
