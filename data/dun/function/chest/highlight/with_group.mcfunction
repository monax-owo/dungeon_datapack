...
execute if data storage dun: _filtered_positions run function util:for_array {command:"function dun:chest/highlight/_summon_highlight with storage util: args[0]", data:"storage dun: _filtered_positions", for_id:0, start_index: 0}
