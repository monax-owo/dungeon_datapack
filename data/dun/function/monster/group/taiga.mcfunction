...
execute if score #value _rand matches 36..40 run function dun:monster/summon/breeze
execute if score #value _rand matches 41..50 run function dun:monster/summon/stray
