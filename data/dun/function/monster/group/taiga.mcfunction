...
execute if score #value _rand matches 4 run function dun:monster/summon/breeze
execute if score #value _rand matches 5 run function dun:monster/summon/stray
