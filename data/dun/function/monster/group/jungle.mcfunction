...
execute store result score #value _rand run random value 1..55
...
execute if score #value _rand matches 36..45 run function dun:monster/summon/pillager
execute if score #value _rand matches 46..55 run function dun:monster/summon/bogged
