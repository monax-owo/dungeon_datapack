...
execute store result score #health dun.calc run data get storage calc: health 100
execute store result score #ratio dun.calc run data get storage dun: current_group.ratio 100
