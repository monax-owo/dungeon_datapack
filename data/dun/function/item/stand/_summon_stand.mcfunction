...
tag @s add uuid_sel.holder
summon armor_stand ^ ^-1 ^ {Tags:["stand"],Invulnerable:true,DisabledSlots:63,NoBasePlate:true,NoGravity:true,ShowArms:true,Pose:{Body:[4f,0f,0f],Head:[33f,0f,0f],LeftLeg:[14f,0f,12f],RightLeg:[4f,0f,351f],LeftArm:[318f,0f,46f],RightArm:[318f,0f,313f]},equipment:{head:{id:"player_head",count:1,components:{profile:{name:"ka_kun1712"}}},chest:{id:"iron_chestplate",count:1,components:{"trim":{material:"minecraft:diamond",pattern:"minecraft:silence"}}},legs:{id:"iron_leggings",count:1,components:{"trim":{material:"minecraft:diamond",pattern:"minecraft:silence"}}},feet:{id:"iron_boots",count:1,components:{"trim":{material:"minecraft:diamond",pattern:"minecraft:silence"}}}}}
