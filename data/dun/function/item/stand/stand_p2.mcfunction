...
data merge entity @s {Invulnerable:true,NoBasePlate:true,NoGravity:true,ShowArms:true,Pose:{Body:[0f,0f,0f],Head:[0f,0f,0f],LeftLeg:[34f,333f,0f],RightLeg:[34f,40f,23f],LeftArm:[267f,23f,0f],RightArm:[267f,23f,6f]},equipment:{head:{id:"player_head",count:1,components:{profile:{name:"ka_kun1712"}}},chest:{id:"iron_chestplate",count:1},legs:{id:"iron_leggings",count:1},feet:{id:"iron_boots",count:1}}}
particle sonic_boom ^ ^1 ^1.5 0.5 0.5 0.5 0.1 1
