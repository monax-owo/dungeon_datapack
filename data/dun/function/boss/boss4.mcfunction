...
summon minecraft:wither ~ ~ ~ {DeathLootTable:"dun:item/nether_star",Rotation:[1,0f],CustomName:"ウィザー",Health:500,Tags:["dun","boss4"],attributes:[{base:2.0d,id:"minecraft:scale"},{base:0.4d,id:"minecraft:movement_speed"},{base:500d,id:"minecraft:max_health"},{base:7.0d,id:"minecraft:attack_damage"}]}
