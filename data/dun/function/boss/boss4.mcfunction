...
summon minecraft:wither ~ ~ ~ {Rotation:[180f,0f],CustomName:"ウィザ子",Health:500.0f,Tags:["dun","boss4"],attributes:[{base:2.0d,id:"minecraft:scale"},{base:0.4d,id:"minecraft:movement_speed"},{base:300d,id:"minecraft:max_health"},{base:7.0d,id:"minecraft:attack_damage"}]}
